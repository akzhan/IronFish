...
pre. app_root
pre.   README.textile
pre.   index.php -- bootstrap here
pre.   .htaccess
pre.   scripts/ -- filled by theme installation
pre.     default/
pre.   styles/ -- filled by theme installation
pre.     default/
pre.   public_data/
pre.   _engine/
pre.     .htaccess
pre.     file_page_cache.php
pre.     routes.php
pre.     mysql.php
pre.     install.php
pre.     bootstrap.php.dist
pre.     bootstrap.php.tmpl
pre.     app/
pre.       cells/
pre.       controllers/
pre.       views/
...
pre.     themes/
pre.       default/
pre.         metadata.yml -- describes steps to install theme automatically
pre.         layout/
